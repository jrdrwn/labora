...
import { MataKuliah } from './columns';

interface FilterMataKuliahInputProps<TData> {
  table: Table<TData>;
}

export function FilterMataKuliahInput<TData>({
  table,
}: FilterMataKuliahInputProps<TData>) {
  return (
    <Input
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            <DeleteConfirmationButton
              listMataKuliah={table
                .getFilteredSelectedRowModel()
                .rows.map((row) => row.original as MataKuliah)}
            />
          </DropdownMenuContent>
        </DropdownMenu>
      )}
