...
import CreateFormKelasButton from '../create-form';
import {
  FilterByKelasButton,
  FilterByRuanganButton,
  FilterByStatusButton,
  FilterColumnsButton,
  FilterKelasPraktikumInput,
      ...
      <div>
        <div className="flex items-center justify-between pb-4">
          <div className="flex items-center gap-2">
            <FilterKelasPraktikumInput table={table} />
            <FilterByRuanganButton table={table} />
            <FilterByKelasButton table={table} />
            <FilterByStatusButton table={table} />
            <SelectRowsActionButton table={table} />
          </div>
          <div className="flex items-center gap-2">
            <FilterColumnsButton table={table} />
            <CreateFormKelasButton />
          </div>
        </div>
      </div>
