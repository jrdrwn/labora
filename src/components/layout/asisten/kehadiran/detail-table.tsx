    ...
    <>
      ...
      <div>
        <Card className="w-full">
          <CardContent>
            {mode === 'edit' && <EditTable detailKehadiran={detailKehadiran} />}
            {mode === 'view' && <ViewTable detailKehadiran={detailKehadiran} />}
          </CardContent>
        </Card>
      </div>
    </>
...
function MakeTableHeader({
  ...
  detailKehadiran: DetailKehadiran | null;
}) {
  return (
    <TableHeader>
      <TableRow>
...
function ViewTable({
  ...
  return (
    <Table>
      <MakeTableHeader detailKehadiran={detailKehadiran} />
      <TableBody>
