      ...
      <div className="grid grid-flow-row grid-cols-1 gap-4 lg:grid-cols-3 lg:grid-rows-2">
        <Card className="py-3 sm:py-6 lg:row-span-2 lg:py-4 xl:py-6">
          <CardContent className="flex flex-col gap-4 px-3 sm:px-6 lg:px-4 xl:px-6">
            ...
            <CardDescription className="text-base xl:text-lg">
              Praktikum melibatkan banyak pihak:
              admin, asisten, dan praktikan. Sistem ini hadir untuk memudahkan
              pengelolaan data, jadwal, kehadiran, dan penilaian secara
              terintegrasi.
            </CardDescription>
            <CardDescription className="text-base xl:text-lg">
              ...
              membantu mengurangi human error, mempercepat akses informasi,
              dan meningkatkan kolaborasi antar pihak.
            </CardDescription>
            <CardDescription className="text-base xl:text-lg">
        ...
        <Card className="py-3 sm:py-6 lg:col-span-1 lg:py-4 xl:py-6">
          <CardContent className="flex flex-col gap-4 px-3 sm:px-6 lg:px-4 xl:px-6">
            ...
            <CardDescription className="text-base xl:text-lg">
              Asisten dapat mengelola kehadiran, penilaian, dan laporan praktikum
              secara online. Kolaborasi antara admin, asisten, dan praktikan
              menjadi lebih mudah.
            </CardDescription>
          </CardContent>
        </Card>
        <Card className="py-3 sm:py-6 lg:col-span-2 lg:py-4 xl:py-6">
          <CardContent className="flex flex-col gap-4 px-3 sm:px-6 lg:px-4 xl:px-6">
            <Image
              src={'https://images.unsplash.com/photo-1587691592099-24045742c181'}
            ...
            <CardDescription className="text-base xl:text-lg">
              ...
              Setiap user (admin, asisten, praktikan) memiliki akses sesuai peran
              dan kebutuhan.
            </CardDescription>
          </CardContent>
        </Card>
